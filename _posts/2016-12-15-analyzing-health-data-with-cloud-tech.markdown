...
During the last one and a half years or so I gave up or altered most of the tracking (apart from my weight) and focused mainly on doing weight training sessions that put hard work on all of my main muscles. This did a lot for my muscle mass, fitness and overall wellbeing, but were not effective in loosing body fat which is also a main asset for me. This took another turn about three months ago when I had a longer talk with my trainer at the gym about this situation. I got some tips on how to eat better, changed my training pattern from long sessions to HIIT (high intensity interval training) and started tracking my daily Calorie intake to not consume more energy than my resting metabolic rate (RMR) will burn. The idea behind this is to force my body to source the energy needed for motion and mental activity from body fat while using training to prevent muscle decrease.

When starting to follow this approach I could almost immediately see my weight and body fat decrease. However, I could also see significant swings in my progress as fast. 

This got me my scratching my head quite a bit and one thought struck me: I consider myself to have quite some understanding about how to run cloud-, application- and server systems and how to methodically and monitor performance and analyse problems there. However, this is not so true for understanding my body and its metabolic processes. Which are the factors that speed up or slow down my fat metabolism with seemingly consistent inputs? Building on top of this, some other thoughts came up. Can we adopt the approaches we use for analyzing logs, events and system performance on health data? I started researching apps and services that help me reveal correlation between different kinds of health data but couldn't find what I was looking for, so I decided to build a prototype to see if this approach is able to give some insight and reveal some patterns.
