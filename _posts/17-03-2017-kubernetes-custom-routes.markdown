...
3. Our new component will watch the Kubernetes API for these resources and Endpoint changes to the configured services and keep the routing table entries up to date on a node level. 
